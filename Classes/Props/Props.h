...
const std::vector<Propsvalue> parameter = {
	...
	Propsvalue("Sickle.png",4,1,1,1),Propsvalue("Sword.png",3,0,1,1),Propsvalue("Darts.png",1,1,1,1),Propsvalue("Bullet.png",2,0,1,1),Propsvalue("HelloWorld.png",1,1,1,1),
